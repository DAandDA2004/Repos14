...
public class MyListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ( v == null){
            ...
            holder.capitalId = ((TextView) v.findViewById(R.id.capital));
        ...
        holder.capitalId.setText(v.getResources().getString(dataFlags.getCapitalID()));
